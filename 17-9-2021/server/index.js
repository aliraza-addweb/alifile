...
app.post("/api/insert2", (req, res) =>
{
    ...
    console.log('Date', today);
    const sqlInsert = "INSERT INTO offer_details (offername, offercode, image, Date) VALUES (?,?,?,?)";
    db.query(sqlInsert, [offername, offercode, image , today], (err, result) =>
    {
        console.log(result);
    });
});
...
app.listen(3007, () =>{
    console.log("runnig on port 3007");
});